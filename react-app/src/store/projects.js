...
export const createProject = (nonprofit_id, title, description, karma_per_share, cost_per_share, total_shares, end_time) => async (dispatch) => {
    ...
    body: JSON.stringify({
        nonprofit_id, title, description, karma_per_share, cost_per_share, total_shares, end_time
    }),
  });
